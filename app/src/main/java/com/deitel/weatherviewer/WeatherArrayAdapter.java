...
class WeatherArrayAdapter extends ArrayAdapter<Weather> {
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null) { // no reusable ViewHolder, so create one
         ...
         viewHolder.DataDayTextView =
                 (TextView) convertView.findViewById(R.id.DataDayTextView);
      ...
      viewHolder.dayTextView.setText(context.getString(
         R.string.day_description, day.dayOfWeek, day.description));//подменить рукими case
      viewHolder.DataDayTextView.setText(context.getString(
              R.string.dataDay_temp, day.dataDay));
